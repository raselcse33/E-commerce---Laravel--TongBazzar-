                                ...
                                @foreach($orders as $order)
                                    <tr>
                                        ...
                                        <td class="align-middle">
                                            <a class="btn btn-info btn-sm mx-1 text-white" href="{{route('details.order',['id'=>$order->id])}}">View</a>
                                            <a class="btn btn-primary btn-sm mx-1 text-white" href="{{route('pending',['id'=>$order->id])}}">pending</a>
